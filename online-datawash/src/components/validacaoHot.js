...
export default class ValidacaoHot extends Component {
 ...
 // evento enviado pelo botão substitui o componente <Enriquec/> por <Enriquec2/>
  handlePage2 = () => {
    this.setState({ view: < Enriquec2 clickAvancar={this.handlePage4} clickVoltar={this.handlePage1} /> })
  }
  ...
  handlePage4 = () => {
    this.setState({ view: <Enriquec4 clickAvancar={this.handlePage5} clickVoltar={this.handlePage2} /> })
  }
  handlePage5 = () => {
  ...
  render() {
    ...
    return (
      <div className=''>
      <h5 className='text-center'>Tela de Validação Hot</h5>
