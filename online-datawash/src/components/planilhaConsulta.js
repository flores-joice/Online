  ...
  <div className='bg-white rounded my-3 p-3 text-center h5'>Joice Flores Lazarino</div>
    ...
    <div className="accordion" id="accordionExample">
      ...
      <div className="card">
        ...
        <div className="collapse show" id="collapseTwo" aria-labelledby="headingTwo" data-parent="#accordionExample">
          <div className="card-body d-flex flex-wrap">
            <p className='col-3'>(11) 3696-8074</p>
            <p className='col-3'>(11) 4376-7894</p>
            <p className='col-3'>(32) 99947-8628 (celular)</p>
            <p className='col-3'>(11) 99643-3672 (celular)</p>
            <p className='col-3'>(32) 99950-8257 (celular)</p>
            <p className='col-3'>(32) 99928-7139</p>
            <p className='col-3'>(32) 3741-6816 (comercial)</p>
          </div>
        </div>
      </div>
      <div className="card">
      ...
      <div className="card">
        ...
        <div className="collapse show" id="collapseFour" aria-labelledby="headingFour" data-parent="#accordionExample">
          <div className="card-body d-flex flex-wrap">
            <p className='col-6'>R HELIOTROPIO 239 CS 4	MUTINGA	OSASCO	SP	06286120</p>
            <p className='col-6'>R WIDGISTON MENDES DE SO 75		CARANGOLA	MG	36800000</p>
          </div>
        </div>
      </div>
      <div className="card">
      ...
      <div className="card">
        ...
        <div className="collapse show" id="collapseSix" aria-labelledby="headingSix" data-parent="#accordionExample">
          <div className="card-body d-flex flex-wrap">
      ...
      <div className="card">
        ...
        <div className="collapse show" id="collapseSeven" aria-labelledby="headingSeven" data-parent="#accordionExample">
          <div className="card-body">
          <div className='d-flex border-top '>
            <p className='col'>MARIA THEREZA FARO NOGUEIRA FOTOCOPIAS		</p>
            <p className='col'>HELIOTROPIO 239</p>
          </div>
          <div className='d-flex border-top '>
            <p className='col'>TANIA REGINA DE NOGUEIRA</p>
            <p className='col'>17660877879</p>
            <p className='col'>HELIOTROPIO 239</p>
            <p className='col'>(11) 2218-0490</p>
          </div>
          <div className='d-flex border-top' >
            <p className='col'>MARIA JOANA SOARES DA COSTA</p>
            <p className='col'>HELIOTROPIO 239 C S 4</p>
            <p className='col'>(11) 5992-7830	</p>
            <p className='col'>(11) 3599-2783</p>
          </div>
          <div className='d-flex border-top' >
            <p className='col'>MARCOS ANTONIO AUGUSTINHO DE OLIVEIRA</p>
            <p className='col'>HELIOTROPIO 239 C S 4</p>
            <p className='col'>(11) 3697-0407</p>
            <p className='col'>(11) 99763-7569</p>
            <p className='col'>(11) 95720-3685</p>
            <p className='col'>(11) 95420-3685</p>
          </div>
          <div className='d-flex border-top' >
            <p className='col'></p>
            <p className='col'></p>
