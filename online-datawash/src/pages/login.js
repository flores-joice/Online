    ...
    return (
      <div className='background d-flex justify-content-center align-items-center' >
        <div className='login-filtro d-flex justify-content-center align-items-center flex-column'>
          <form className='login-section d-flex flex-column justify-content-center align-items-center px-3 rounded shadow-lg' >
            <img src={logo} width="180" height="auto" alt="logo" className='pb-5' />
            <span className='resposta text-danger font-weight-bold position-absolute'></span>
            <input type='email' className='form-control shadow '  autoFocus/>
            ...
            <button type='submit' className='btn btn-info w-75 mt-3 shadow' onChange={this.handleSubmit.bind(this)}> Login</button>
          </form>
        </div>
      </div>
    )
